...
public class KafkaConfig {
    ...
    // MUST be named "defaultRetryTopicKafkaTemplate"
    // ---------------------------------------------------------------
    @Bean
    ...
    // ---------------------------------------------------------------
    // PRODUCER 2: StringSerializer — used by KafkaEventSender / OutboxPublisher
    // ---------------------------------------------------------------
    @Bean
    ...
    public ConsumerFactory<String, SagaEvent> consumerFactory() {
        ...
        deserializer.addTrustedPackages("com.example.payment.event");
